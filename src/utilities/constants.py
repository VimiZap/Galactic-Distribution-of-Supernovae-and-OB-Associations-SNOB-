...
rho_min_spiral_arm = 2.9           # kpc, minimum distance from galactic center to the beginning of the spiral arms.
rho_max_spiral_arm = 35            # kpc, maximum distance from galactic center to the end of the spiral arms.
