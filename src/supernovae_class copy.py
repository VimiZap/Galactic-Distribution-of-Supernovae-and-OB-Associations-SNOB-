...
class SuperNovae:
    ...
    def __init__(self, association_x, association_y, association_z, creation_time, simulation_time):
        ...
        # self._calculate_position() # Really do not need to calculae the position of the supernova here. It is only needed when plotting the supernova.
    ...
    def simulation_time(self, value):
        ...
        if not self.exploded:
            ...
            #self._calculate_position() # update the position of the star # Really do not need to calculae the position of the supernova here. It is only needed when plotting the supernova.
    ...
    def _calculate_mass(self):
        return np.random.choice(self.solar_masses, size=1, p=self.imf/np.sum(self.imf))
