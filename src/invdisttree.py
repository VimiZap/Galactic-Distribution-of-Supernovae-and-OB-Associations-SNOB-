...
if __name__ == "__main__":
    ...
    #print(f"Invdisttree:  N %d  Ndim %d  Nask %d  Nnear %d  leafsize %d  eps %.2g  p %.2g" % {
    #    N, Ndim, Nask, Nnear, leafsize, eps, p})
    print(f"Invdisttree:  N %d  Ndim %d  Nask %d  Nnear %d  leafsize %d  eps %.2f  p %.2f" % (
    N, Ndim, Nask, Nnear, leafsize, eps, p))
...
#...............................................................................
    ...
    print(z.shape)
    print(ask.shape)
    plt.scatter(known.T[0], known.T[1], c=z, cmap='viridis')
    plt.show()
    plt.scatter(ask.T[0], ask.T[1], c=interpol, cmap='viridis')
    plt.show()
